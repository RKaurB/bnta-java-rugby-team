...
//    }
    ...
    public void canCountEmptySpacesOnTeamWithOnePlayer() {
        ...
        Player player = new Player("test player", "winger", 11, 2);
        TeamService underTest = new TeamService();
        // Instead of using the addPlayer method, because we haven't tested it yet, we can directly put player into the team - it should still have the same end result, i.e. should be 14 spaces
